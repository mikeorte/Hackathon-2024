...
function MiniSummary (props: any) {
    ...
    return (
        <div>
        <div id="DateDisplay" className="date-display outlook-shadow bg-blue-accent">
            {subject} | {day}
        </div>
        <div id="Summary-Body" className="summary-display outlook-shadow bg-light-accent">
            {text}
        </div>
        </div>
    )
...
const Summary = (props: any) => {
    ...
    return (
    <main>
        <div id="Header" className={"text-4xl font-semibold rounded my-8 mx-10"}>
            Here's Your Summary
        </div>
